 ...
 */
public class BasicOrOtherTestRequestJson implements Serializable {
    ...
    //<editor-fold desc="BasicOrOtherTestRequestJson Getters and Setters" defaultstate="collapsed">
