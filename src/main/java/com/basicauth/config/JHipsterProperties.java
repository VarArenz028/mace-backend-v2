...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "maceBackend@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "maceBackend API";

        private String description = "maceBackend API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "maceBackend";
